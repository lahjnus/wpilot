...
var OP_SERVER_INFO        = 10;
var OP_SERVER_EXEC_RESP   = 11
var OP_DISCONNECT_REASON  = 12;
var OP_WORLD_DATA         = 13;
var OP_WORLD_STATE        = 14;
var OP_WORLD_RECONNECT    = 15;
var OP_CLIENT_CONNECT     = 16;
var OP_CLIENT_JOIN        = 17;
var OP_CLIENT_STATE       = 18;
var OP_CLIENT_SET         = 19;
var OP_CLIENT_EXEC        = 20;
var OP_CLIENT_SAY         = 21;
 ...
 *  Spawns a new bullet.
 */
World.prototype.fire_player_canon = function(player_id, angle, pos, vel) {
  var player = this.players[player_id];
  var ship = player.entity;
  var entity = new Bullet({
    lifetime: this.tick + (BULLET_LIFETIME *  this.delta),
    pos: pos || [
  ...
  this.on_player_fire(player, angle, entity.pos, entity.vel);
  return entity;
}
